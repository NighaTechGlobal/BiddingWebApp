...
{{--    <meta name="description" content="getbid.in - Tender & Auction Portal &amp; ">--}}
{{--    <meta name="author" content="pixelcave">--}}
{{--    <meta name="robots" content="noindex, nofollow">--}}

{{--    <!-- Open Graph Meta -->--}}
{{--    <meta property="og:title" content="getbid.in - Tender & Auction Portal &amp; ">--}}
{{--    <meta property="og:site_name" content="getbid.in ">--}}
{{--    <meta property="og:description" content="getbid.in - Tender & Auction Portal &amp; ">--}}
...
{{--                                <form class="js-validation-signin" method="POST" action="{{ route('loginauth') }}">--}}
{{--                                    @csrf--}}
{{--                                    <div class="py-3">--}}
{{--                                        <div class="mb-4">--}}
